...
class MotivationalQuoteScreen extends StatefulWidget {
  const MotivationalQuoteScreen({Key? key}) : super(key: key);

  @override
  State<MotivationalQuoteScreen> createState() =>
      _MotivationalQuoteScreenState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: FutureBuilder(
          future: DBHelpers.dbHelpers.fetchMRecord(),
